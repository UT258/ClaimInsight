...
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.claiminsight.ingestion.controller.*.*(..))")
    ...
    public Object logAround(ProceedingJoinPoint jp) throws Throwable {
        ...
        try {
            ...
            log.info("[AROUND] {}.{}() completed in {} ms", jp.getTarget().getClass().getSimpleName(), jp.getSignature().getName(), System.currentTimeMillis() - start);
            return result;
        } catch (Throwable ex) {
