 ...
 * Fan-out form — delivers a notification to every user matching any of
 * {@code targetUserIds} or {@code targetRoles}. Role strings map by name to
 * the server-side {@code UserRole} enum (ANALYST, MANAGER, FRAUD, ACTUARY,
 * EXECUTIVE, ADMIN).
 */
@Data
@NoArgsConstructor
